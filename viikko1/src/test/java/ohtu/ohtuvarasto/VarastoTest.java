...
public class VarastoTest {
    ...
    @Test
    public void varastostaSaadaanMaksimissaanSaldonVerran() {
        varasto.lisaaVarastoon(1);
    ...
    @Test
    public void varastoonVoidaanLaittaaMaksimissaanTilavuudenVerran() {
    ...
    @Test
    public void eiVoiLuodaVarastoaNegatiivisellaTilavuudella() {
    ...
    @Test
    public void eiVoiLuodaVarastoaNegatiivisellaSaldolla() {
    ...
    @Test
    public void eiVoiLuodaVarastoaTilavuuttaSuuremmallaSaldolla() {
        Varasto varasto = new Varasto(1, 2);
